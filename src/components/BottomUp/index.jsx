		...
		<>
			<s.Background onClick={handleBackgroundClick}>
				<s.Container onClick={handleContainerClick}>
					...
					<s.TimeGroup>
						<s.SelectGroup>
							<s.Select value={selectedDay} onChange={handleDayChange}>
							...
							<s.SelectTime>
								<s.Time value={startTime} onChange={handleStartChange}>
								...
								~
								<s.Time value={finishTime} onChange={handleFinishChange}>
